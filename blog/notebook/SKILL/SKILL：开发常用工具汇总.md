...
- (MemoryAnalyzer + Jconsole + jmap) ： 内存分析，(1、jconsole监控;2、jmap -dump:format=b,file=文件名.bin [pid];3、MemoryAnalyzer打开dump的bin文件 (或：jhat -J-Xmx1024M [file] 并查看 "Other>instance count、heap class" 属性排查；) ； )
