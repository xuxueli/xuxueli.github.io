...
![](https://www.xuxueli.com/blog/static/images/default/img_231.png)

** 如何让key和缓存节点对应起来呢？ **
很简单，每一个key的顺时针方向最近节点，就是key所归属的缓存节点。所以图中key1存储于node1，key2，key3存储于node2，key4存储于node3。

![](https://www.xuxueli.com/blog/static/images/default/img_232.png)
...
![](https://www.xuxueli.com/blog/static/images/default/img_233.png)

** 有哪些key会受到影响呢？ **
图中加入了新节点node4，处于node1和node2之间，按照顺时针规则，从node1到node4之间的缓存不再归属于node2，而是归属于新节点node4。因此受影响的key只有key2。

![](https://www.xuxueli.com/blog/static/images/default/img_234.png)
...
![](https://www.xuxueli.com/blog/static/images/default/img_235.png)

** 有哪些key会受到影响呢？ **
图中删除了原节点node3，按照顺时针规则，原本node3所拥有的缓存数据就需要“托付”给node3的顺时针后继节点node1。因此受影响的key只有key4。

![](https://www.xuxueli.com/blog/static/images/default/img_236.png)
...
![](https://www.xuxueli.com/blog/static/images/default/img_237.png)
...
![](https://www.xuxueli.com/blog/static/images/default/img_238.png)
