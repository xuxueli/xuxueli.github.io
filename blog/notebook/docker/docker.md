...
// 4、推送镜像至docker-hub仓库
锁定镜像：docker images
登陆Hub：docker login (或 docker login docker.io )
tag镜像：docker tag <imageID> <namespace>/<image name>:<version tag eg latest>
push镜像：docker push <namespace>/<image name>:<version tag eg latest>
```
